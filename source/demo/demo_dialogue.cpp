...
// dialogue content
Dialogue demo_yukari_kenji_argument_lines[29];
void demo_yukari_kenji_argument_init()
{
    ...
    DialogueSelection demo_yukari_kenji_argument_sel_6_1 = {
        "Side with Aigis", false, &demo_yukari_kenji_argument_lines[12]};
    DialogueSelection demo_yukari_kenji_argument_sel_6_2 = {
        "Ask what's outside", false, &demo_yukari_kenji_argument_lines[15]};

    DialogueSelection demo_yukari_kenji_argument_sel_19_0 = {
        "Offer to walk her", false, &demo_yukari_kenji_argument_lines[20]};
    DialogueSelection demo_yukari_kenji_argument_sel_19_1 = {
        "Tell her it can wait", false, &demo_yukari_kenji_argument_lines[23]};
    DialogueSelection demo_yukari_kenji_argument_sel_19_2 = {
        "Follow the rule", false, &demo_yukari_kenji_argument_lines[26]};

    demo_yukari_kenji_argument_lines[0] = {"Aigis",
                                           ...
                                           {}};
    demo_yukari_kenji_argument_lines[1] = {"Yukari",
                                           ...
                                           {}};
    demo_yukari_kenji_argument_lines[2] = {"Aigis",
    ...
    demo_yukari_kenji_argument_lines[4] = {"Yukari",
                                           ...
                                           {}};
    demo_yukari_kenji_argument_lines[5] = {"Aigis",
    ...
    demo_yukari_kenji_argument_lines[7] = {"Akihiko",
                                           ...
                                           {}};
    demo_yukari_kenji_argument_lines[8] = {"Aigis",
                                           "...Processing.",
                                           BustAigis::spNeutral,
    ...
    demo_yukari_kenji_argument_lines[10] = {"Yukari",
                                            ...
                                            {}};
    demo_yukari_kenji_argument_lines[11] = {"Akihiko",
                                            "...Guess I'm coming along, then.",
                                            BustAkihiko::spNeutral,
                                            &demo_yukari_kenji_argument_lines[10],
                                            NULL,
                                            {}};
    ...
    demo_yukari_kenji_argument_lines[15] = {"Akihiko",
                                            ...
                                            {}};
    demo_yukari_kenji_argument_lines[16] = {"Aigis",
    ...
    demo_yukari_kenji_argument_lines[17] = {
        ...
        BustAigis::spNeutral,
        &demo_yukari_kenji_argument_lines[16],
        &demo_yukari_kenji_argument_lines[18],
        {}};
    demo_yukari_kenji_argument_lines[18] = {"Yukari",
                                            "I-it's not like it's haunted or anything. It's just a rule.",
                                            BustYukari::spNeutral,
                                            &demo_yukari_kenji_argument_lines[17],
                                            &demo_yukari_kenji_argument_lines[19],
                                            {}};
    demo_yukari_kenji_argument_lines[19] = {"Akihiko",
                                            "Alright. So what do we do about the bag.",
                                            BustAkihiko::spNeutral,
                                            &demo_yukari_kenji_argument_lines[18],
                                            NULL,
                                            {demo_yukari_kenji_argument_sel_19_0,
                                             demo_yukari_kenji_argument_sel_19_1,
                                             demo_yukari_kenji_argument_sel_19_2}};

    // Sub-branch: Offer to walk her there yourself
    demo_yukari_kenji_argument_lines[20] = {
        "Aigis",
        "...Acceptable. I will permit this. Return within five minutes, or I will come retrieve you both.",
        BustAigis::spNeutral,
        &demo_yukari_kenji_argument_lines[19],
        &demo_yukari_kenji_argument_lines[21],
        {}};
    demo_yukari_kenji_argument_lines[21] = {"Yukari",
                                            "Thanks, Akihiko. Didn't expect that from you.",
                                            BustYukari::spNeutral,
                                            &demo_yukari_kenji_argument_lines[20],
                                            &demo_yukari_kenji_argument_lines[22],
                                            {}};
    demo_yukari_kenji_argument_lines[22] = {"Akihiko",
    ...
    demo_yukari_kenji_argument_lines[23] = {"Yukari",
                                            "...Fine. It's just a bag.",
                                            BustYukari::spNeutral,
                                            &demo_yukari_kenji_argument_lines[19],
                                            &demo_yukari_kenji_argument_lines[24],
                                            {}};
    demo_yukari_kenji_argument_lines[24] = {"Aigis",
                                            "A reasonable decision. Sanada's judgment is noted favorably.",
                                            BustAigis::spNeutral,
                                            &demo_yukari_kenji_argument_lines[23],
                                            &demo_yukari_kenji_argument_lines[25],
                                            {}};
    demo_yukari_kenji_argument_lines[25] = {
        "Yukari", "Don't get used to it.", BustYukari::spNeutral, &demo_yukari_kenji_argument_lines[24], NULL, {}};

    // Sub-branch: Agree the rule's there for a reason
    demo_yukari_kenji_argument_lines[26] = {"Yukari",
                                            "Oh, come on. Not you too.",
                                            BustYukari::spNeutral,
                                            &demo_yukari_kenji_argument_lines[19],
                                            &demo_yukari_kenji_argument_lines[27],
                                            {}};
    demo_yukari_kenji_argument_lines[27] = {"Aigis",
                                            "Agreement noted. My assessment of Sanada has improved.",
                                            BustAigis::spNeutral,
                                            &demo_yukari_kenji_argument_lines[26],
                                            &demo_yukari_kenji_argument_lines[28],
                                            {}};
    demo_yukari_kenji_argument_lines[28] = {"Yukari",
                                            "I'm going to bed. Alone. On purpose.",
                                            BustYukari::spNeutral,
                                            &demo_yukari_kenji_argument_lines[27],
                                            NULL,
                                            {}};
